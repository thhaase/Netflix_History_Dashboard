# to deploy on rsconnect follow the website linked in the readme for this repo and use the command below
#rsconnect::deployApp('PATH TO FOLDER WHERE THIS SCRIPT LIES IN')
